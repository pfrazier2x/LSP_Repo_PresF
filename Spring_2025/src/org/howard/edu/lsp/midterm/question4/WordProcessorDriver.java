...
public class WordProcessorDriver {
    public static void main(String[] args) {
        ...
        // Test case 2: Sentence with multiple words of the same max length
        ...
        // Test case 3: Sentence with multiple occurrences of the same longest word
        WordProcessor wp3 = new WordProcessor("Hello world, welcome to Java Java");
